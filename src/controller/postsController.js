  ...
  postPost = async (req, res) => {
    ...
    try {
      ...
      try {
        ...
        request.input('postedPrice', sql.Decimal(10, 3), postedPrice);
        request.input('availableAmount', sql.Decimal(10, 3), availableAmount);
        request.input('minAmount', sql.Decimal(10, 3), minAmount);
        request.input('maxAmount', sql.Decimal(10, 3), maxAmount);
